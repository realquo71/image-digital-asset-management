...
import { mockContacts } from '@/crm/mock/contacts'; // mockContacts fayli mavjud deb faraz qilamiz
...
export function NoteList({ filter }) {
  ...
  const statusCounts = useMemo(() => {
    return filteredByTab.reduce((acc, note) => {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex truncate overflow-hidden gap-1.5">
              {contactIds.slice(0, 3).map((contactId) => {
